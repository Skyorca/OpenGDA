...
if __name__ == '__main__':
    ...
    for rep_times in range(args.repeat):
        model = UDAGCN_LP(args.UDAGCN, encoder_dim=encoder_dim,num_gcn_layers=num_gcn_layers,hidden_dims=hidden_dims,device=args.device, is_bipart_graph=is_bipart_graph).to(args.device)
