...
parser.add_argument('--model_name', type=str, default='GRADE-original', help='model name')
...
if __name__ == '__main__':
    ...
    # num_user_ds num_item_dt等是每个域上的用户 商品总数
        model = GRADE_LP(args, num_item_ds, num_user_ds, num_item_dt, num_user_dt, adj_s, adj_t, feats_s, feats_t)
